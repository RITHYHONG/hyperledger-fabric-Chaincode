...
echo PackageID is ${PACKAGE_ID}
 ...
 peer lifecycle chaincode approveformyorg -o localhost:7050 \
        --tls \
        --cafile /home/kakapo/testsin/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem \
        --channelID channel --name mycc --version 1 \
